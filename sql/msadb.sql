...
INSERT INTO `holiday` VALUES (1,'Araw ng Pag-ibig',0,1,1),(2,'s',1,0,1);
...
INSERT INTO `holiday_instance` VALUES (1,1,'2017-09-27 00:00:00','2017-09-27 00:00:00'),(2,2,'2017-09-28 00:00:00','2017-09-28 00:00:00');
...
BEGIN
	delete from withtax_value where withtax_value.wid = OLD.wbid;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2017-09-25 16:38:06
