    ...
    public partial class PayrollConfHolidays : Form {
        ...
        private void AddBTN_Click(object sender, EventArgs e) {
            if (DataVal()) {
                ...
                else { Holiday.EditHoliday(int.Parse(HolidaysGRD.SelectedRows[0].Cells[0].Value.ToString()), DescBX.Text, type); CancelBTN.PerformClick(); }
                LoadPage();
            }
        }
        ...
        private void EditBTN_Click(object sender, EventArgs e) {
            if (HolidaysGRD.SelectedRows.Count > 0) {
                _start = new DateTime(int.Parse(HolidaysGRD.SelectedRows[0].Cells[1].Value.ToString().Split('/')[2]), int.Parse(HolidaysGRD.SelectedRows[0].Cells[1].Value.ToString().Split('/')[0]), int.Parse(HolidaysGRD.SelectedRows[0].Cells[1].Value.ToString().Split('/')[1]));
                _end = new DateTime(int.Parse(HolidaysGRD.SelectedRows[0].Cells[2].Value.ToString().Split('/')[2]), int.Parse(HolidaysGRD.SelectedRows[0].Cells[2].Value.ToString().Split('/')[0]), int.Parse(HolidaysGRD.SelectedRows[0].Cells[2].Value.ToString().Split('/')[1]));
