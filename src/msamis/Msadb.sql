...
INSERT INTO `address` VALUES (7,2,1,NULL,'City1','001','Brgy1','Street1'),(8,2,2,NULL,'City2','002','Brgy2','Street2'),(9,2,3,NULL,'City3','003','Brgy3','Street3');
...
CREATE TABLE `assignment` (
  ...
  CONSTRAINT `Assignment-Request` FOREIGN KEY (`RID`) REFERENCES `requestforassignment` (`RID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `dependents` VALUES (10,4,'fads','fads1','fads2',2),(11,5,'mads','mads1','mdas2',2),(12,6,'sp','sp2','sp3',2),(13,2,'dep2','dep22','dep333',2),(14,2,'dep2','dep22','dep333',2);
...
INSERT INTO `guards` VALUES (2,'GuardFirst','GuardMiddle','GuardLast',1,'6/8/1994',1,'1 11','222 kg.','Islam',1,'+63 977 344 4492','521-023','111 111 111','222 222 222','333 333 333','44-444444444-4','Prev Daw','2PrevAs Adw',2,'BSCS','Training','Kinsa Contact','09092626');
...
CREATE TABLE `requestlocations` (
  ...
  PRIMARY KEY (`RLID`),
  KEY `Request-RequestLocation_idx` (`RID`),
  CONSTRAINT `Request-RequestLocation` FOREIGN KEY (`RID`) REFERENCES `requestforassignment` (`RID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-03-28  0:40:43
-- MySQL dump 10.13  Distrib 5.7.12, for Win64 (x86_64)
--
...
-- Dump completed on 2017-03-28  0:40:44
